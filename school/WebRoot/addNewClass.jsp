...
<html>
  ...
  <body class="hold-transition skin-blue sidebar-mini">>
   ...
   <aside class="main-sidebar">
  	...
  	<s:form action="addNewClass" method="post" cssClass="dark-matter">
	  	<h1>添加一门新课
	    <span>请填写下列表单</span>
	    </h1>
	    <label>
	    <span>课程课号</span>
	    <s:textfield cssType="text" name="cla.cno" placeholder="课程课号" />
	    </label>
    	<label>
	    <span>课程名称</span>
	    <s:textfield cssType="text" name="cla.cname" placeholder="课程名称" />
	    </label>
    	<label>
	    <span>平时分所占比例：（%）</span>
	    <s:textfield cssType="text" name="cla.rate" placeholder="平时分所占比例：（%）" />
	    </label>
    	<label>
	    <span>学分</span>
	    <s:textfield cssType="text" name="cla.credit" placeholder="学分" />
	    </label>
    	<label>
	    <span>选择你的学院</span>
	    <s:select list="ddlist" name="cla.d.deptNo" listKey="key" listValue="value" label="选择你的学院"/>
	    </label>
